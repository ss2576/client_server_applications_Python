...
from common.classes.request_body import Msg
from common.utils import *
from server_database import ServerStorage
from gui.server_ui_logic import *
...
def main():
    ...
    db_file = config['database'] if config and 'database' in config else 'server_database.db3'
